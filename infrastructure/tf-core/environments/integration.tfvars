    ...
    network_rules = [
      {
        ...
        source_addresses      = ["10.138.0.0/16"]
        destination_addresses = ["10.139.0.0/16"]
        protocols             = ["TCP", "UDP"]
      ...
      },
      {
        ...
        destination_addresses = ["10.138.0.0/16"]
        protocols             = ["TCP", "UDP"]
        destination_ports     = ["443"]
      }
    ]
...
sqlserver = {
  ...
  sql_admin_group_name                 = "sqlsvr_svclyr_int_uks_admin"
  ad_auth_only                         = true

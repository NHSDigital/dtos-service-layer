module "azure_sql_server" {
  ...
  # Default database
  db_name_suffix = var.sqlserver.dbs.svclyr.db_name_suffix
  collation      = var.sqlserver.dbs.svclyr.collation
  licence_type   = var.sqlserver.dbs.svclyr.licence_type
  max_gb         = var.sqlserver.dbs.svclyr.max_gb
  read_scale     = var.sqlserver.dbs.svclyr.read_scale
  sku            = var.sqlserver.dbs.svclyr.sku
